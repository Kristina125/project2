...
var accordion = function accordion(triggersSelector) {
  var btns = document.querySelectorAll(triggersSelector); //   blocks = document.querySelectorAll(itemssSelector);
...
var drop = function drop() {
  ...
  function hightlight(item) {
    item.closest('.file_upload').style.border = "1px dotted #c51abb";
